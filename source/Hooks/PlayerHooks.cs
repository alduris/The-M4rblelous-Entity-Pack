...
public static class PlayerHooks
{
    ...
    {
        if (obj is ThornyStrawberry or BlobPiece or BouncingMelon or LittleBalloon or TintedBeetle or Physalis or LimeMushroom or GummyAnther or MarineEye or SmallPuffBall)
    ...
    internal static void InitGourmandCombos()
    {
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.WaterNut], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[AbstractObjectType.BlobPiece], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.JellyFish], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.Mushroom], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[AbstractObjectType.LimeMushroom], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.ScavengerBomb], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.SporePlant], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.EggBugEgg], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.SingularityBomb], 0, MoreSlugcatsEnums.AbstractObjectType.FireEgg, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.Seed], 0, null, CreatureTemplate.Type.SmallCentipede);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.GooieDuck], 0, AbstractPhysicalObject.AbstractObjectType.Mushroom, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.LillyPuck], 0, AbstractPhysicalObject.AbstractObjectType.Mushroom, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.GlowWeed], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.SporeProjectile], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.DandelionPeach], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[AbstractObjectType.LimeMushroom], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.KarmaFlower], 0, MoreSlugcatsEnums.AbstractObjectType.Seed, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.Mushroom], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.FlyLure], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.BubbleGrass], 0, MoreSlugcatsEnums.AbstractObjectType.LillyPuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.SingularityBomb], 0, MoreSlugcatsEnums.AbstractObjectType.FireEgg, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.Seed], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.GooieDuck], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.LillyPuck], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.GlowWeed], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.Physalis], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.DandelionPeach], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[AbstractObjectType.LimeMushroom], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.KarmaFlower], 0, MoreSlugcatsEnums.AbstractObjectType.Seed, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.Mushroom], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.FlyLure], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.BubbleGrass], 0, MoreSlugcatsEnums.AbstractObjectType.LillyPuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.SingularityBomb], 0, MoreSlugcatsEnums.AbstractObjectType.FireEgg, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.Seed], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.GooieDuck], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.LillyPuck], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.GlowWeed], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.GummyAnther], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.DandelionPeach], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.WaterNut], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.Mushroom], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[AbstractObjectType.LimeMushroom], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.ScavengerBomb], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[AbstractPhysicalObject.AbstractObjectType.SporePlant], 0, MoreSlugcatsEnums.AbstractObjectType.GooieDuck, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.SingularityBomb], 0, MoreSlugcatsEnums.AbstractObjectType.FireEgg, null);
        ...
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.Seed], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.GooieDuck], 0, AbstractPhysicalObject.AbstractObjectType.Mushroom, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.LillyPuck], 0, AbstractPhysicalObject.AbstractObjectType.Mushroom, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.GlowWeed], 0, AbstractObjectType.MarineEye, null);
        GourmandCombos.SetLibraryData(GourmandCombos.objectsLibrary[AbstractObjectType.LittleBalloon], GourmandCombos.objectsLibrary[MoreSlugcatsEnums.AbstractObjectType.DandelionPeach], 0, AbstractPhysicalObject.AbstractObjectType.DangleFruit, null);
